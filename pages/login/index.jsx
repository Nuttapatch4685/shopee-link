...
const LoginPage = () => {
  ...
  return (
    <div className="px-4">
      <div className="lg:w-[500px] w-full bg-white border border-gray-200 lg:absolute lg:-translate-y-1/2 lg:-translate-x-1/2  lg:top-1/2 lg:left-1/2 lg:px-8 px-4 py-18 rounded-lg lg:mt-0 mt-40">
        <div className="mb-4">
