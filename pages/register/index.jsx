...
const RegisterPage = () => {
  ...
  return (
    <div className="px-4">
      <div className="lg:w-[500px] w-full bg-white border border-gray-200 lg:absolute lg:-translate-y-1/2 lg:-translate-x-1/2  lg:top-1/2 lg:left-1/2 lg:px-8 px-4 py-18 rounded-lg lg:mt-0 mt-4">
          ...
          <div className={classNames(errors.username ? "mb-1" : "mb-6")}>
            ...
            <TextField
              ...
              {...register("username", {
                ...
                minLength: {
                  value: 8,
                  message: "รหัสผ่านต้องมีความยาว 8-15 ตัวอักษร",
                },
                maxLength: {
                  value: 15,
                  message: "รหัสผ่านต้องมีความยาว 8-15 ตัวอักษร",
